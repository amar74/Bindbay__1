                        ...
                        <div class="home-wrapper">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="home-content">
                                    ...
                                    <h1>Bindbay Promised Quality Service in Greater Noida & Delhi - NCR</h1>
									<p> Bindbay provides many different kind of services. </p>
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                                            <div class="home-contact">
                                                 <div class="features_buttom">
                                    <a href="Registration/registration.php" class="btn btn-default">Book Now</a>
                                </div>
                    ...
                    <div class="main_features_content2">
                        ...
                        <div class="col-sm-6">
                            <div class="single_features_left text-center">
                                <img src="assets/images/gallery/bindbay/hardbind.jpg" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 margin-top-60">
                            <div class="single_features_right ">
                                <h2>HARD BINDING</h2>
                                <p>Bindbay Provides these features</p>
                                <ul>
                                    <li>Good quality of pages</li>
                                    <li>Fine Binding</li>
									<li>A5, A4, Type of pages </li>
									<li>Black/Green/Mehroon Red/Blue/Golden</li>
                                </ul>
                                <div class="features_buttom">
                                    <a href="Registration/registration.php" class="btn btn-default">Book Now</a>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="main_features_content2">
                        ...
                        <div class="col-sm-6 margin-top-60">
                            <div class="single_features_right ">
                                <h2>HARDBINDING WITH GOLDEN PRINT</h2>
                                <p>Bindbay Provides these features</p>
                                <ul>
                                    <li>Good quality of pages</li>
                                    <li>Fine Binding</li>
